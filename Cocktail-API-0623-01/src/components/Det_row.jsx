        ...
        <>
            ...
            >
                <Box textAlign="center" fontWeight={"light"} bg={useColorModeValue('orange.50', 'blue.800')} borderRadius="xl" p={5} margin={5}>
                    <CheckIcon/>
                    <Text fontSize={"xl"} p={5}>Recipe cocktail finder</Text>
                </Box>
                <Box textAlign="center" fontWeight={"light"} bg={useColorModeValue('orange.50', 'blue.800')} borderRadius="xl" p={5} margin={5}>
                    <StarIcon/>
                    <Text fontSize={"xl"} p={5}>Made with React, Vite and Chakra UI</Text>
                </Box>
                <Box textAlign="center" fontWeight={"light"} bg={useColorModeValue('orange.50', 'blue.800')} borderRadius="xl" p={5} margin={5}>
                    <InfoIcon/>
                    <Text fontSize={"xl"} p={5}>Consuming <Link href="https://www.thecocktaildb.com/api.php" isExternal>TheCocktailDB API</Link></Text>
                </Box>
            </Flex>
        </>
